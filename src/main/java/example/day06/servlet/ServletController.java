...
public class ServletController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //응답
        resp.getWriter().print("response Data: [get]zzzzz");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("request Data:"+req.getParameter("data"));
        //응답
        resp.getWriter().print("response Data: [post]roger");
    }
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("request Data:"+req.getParameter("data"));
        //응답
        resp.getWriter().print("response Data: [put]roger");
    }
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("request Data:"+req.getParameter("data"));
        //응답
        resp.getWriter().print("response Data: [delete]roger");
